...
if [ "$dataset" == "voxc1" ]; then
    cp dataset/voxceleb1/kaldi_files/spk2utt $data_dir
    cp dataset/voxceleb1/kaldi_files/utt2spk $data_dir
    trials=dataset/voxceleb1/kaldi_files/voxceleb1_sv_trials
elif [ "$dataset" == "voxc2" ]; then
    cp dataset/voxceleb2/kaldi_files/spk2utt $data_dir
    cp dataset/voxceleb2/kaldi_files/utt2spk $data_dir
