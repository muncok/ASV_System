...
from system.sv_test import extract_embed_fix_len
...
config['stride_frames'] = config['input_frames']
config['gpu_no'] = [0]
...
# si_embeddings, _ = extract_embed_fix_len(config, si_dataloader, model)
...
sv_embeddings, _ = extract_embed_fix_len(config, sv_dataloader, model)
